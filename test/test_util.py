...
def test_load_vint():
    ...
    assert load_vint(b"\x80\x80\x01", 0) == (1 << 14, 3)
    assert load_vint(b"\x80\x80\x80\x01", 0) == (1 << 21, 4)
    assert load_vint(b"\x80\x80\x80\x80\x01", 0) == (1 << 28, 5)
    assert load_vint(b"\x80\x80\x80\x80\x80\x01", 0) == (1 << 35, 6)
